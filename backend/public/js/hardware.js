...
const excludedFields = ['HA_ID', 'HA_TYPE', 'HA_LOCATION', 'HA_STATUS', 'HA_SIM_CARD', 'HA_CREATED_AT', 'HA_DELETED_AT', 'ST_ID', 'LOC_ID','PROVIDER_NAME', 'TARIFF_NAME', 'STORE_NAME', 'SUPPLIER_NAME', 'CURRENCY_CODE', 'SUPPLIER_NAME', ];
